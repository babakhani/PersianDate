            ...
            if (eq != -1) {
                ...
                if (calendar.toLowerCase() == "gregorian") {
                    ...
                    if (d != null) {
                        ...
                        if (d[2] >= 1 && d[2] <= 12 && d[3] >= 1 && d[3] <= 31 && (d[4] == undefined || d[4].substring(1) >= 0 && d[4].substring(1) <= 23) && (d[5] == undefined || d[5].substring(1) >= 0 && d[5].substring(1) <= 59) && (d[6] == undefined || d[6].substring(1) >= 0 && d[6].substring(1) <= 59)) {
                            document.gregorian.year.value = d[1];
                            document.gregorian.month.selectedIndex = d[2] - 1;
                            document.gregorian.day.value = Number(d[3]);
                            document.gregorian.hour.value = d[4] == undefined ? "00" : d[4].substring(1);
                            document.gregorian.min.value = d[5] == undefined ? "00" : d[5].substring(1);
                            document.gregorian.sec.value = d[6] == undefined ? "00" : d[6].substring(1);
                            calcGregorian();
                            set = true;
                        } else {
