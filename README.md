...
[![Build Status](https://travis-ci.org/babakhani/PersianDate.svg?branch=master)](https://travis-ci.org/babakhani/PersianDate)
...
```javascript
new persianDate([1392,01]).daysInMonth(); // 29
new persianDate([1392,08]).daysInMonth(); // 31
```
