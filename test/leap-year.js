...
describe(`Check total leap years in next ${N_NEXT_YEARS} year, different algorithms`, function () {
	...
	const isLeapYearBirashk = function (year) {
		return (
			parseFloat(
				"0." + ((year + 2346) * 0.24219858156).toString().split(".")[1],
			) < 0.24219858156
		);
	};
	...
	it("Object Create Successfully", function () {
		...
		console.log(
			"- Total Behrooz_Birashk leap year: " + totalLeapCountInBirashk,
		);
		console.log(
		...
		console.log("");
		console.log(
			"- Total Common leap year (nasa, astronomical, algorithmic, Behrooz_Birashk, wiki python, gregorian): " +
				totalCommonNasaAstroAlgo,
		);
		console.log("");
		console.log(
			"- Common leap year (astronomical, NASA): " + totalCommonNasaAstro,
		);
		console.log(
			"- Common leap year (algorithmic, NASA): " + totalCommonNasaAlgo,
		);
		console.log("");
		console.log(
			"- Common leap year (astronomical, Behrooz_Birashk): " +
				totalCommonBirashkAstro,
		);
		console.log(
			"- Common leap year (algorithmic, Behrooz_Birashk): " +
				totalCommonBirashkAlgo,
		);
		console.log("");
		console.log(
			"- Common leap year (astronomical, wiki): " + totalCommonWikiAstro,
		);
		console.log(
			"- Common leap year (algorithmic, wiki): " + totalCommonWikiAlgo,
		);
		console.log("");
